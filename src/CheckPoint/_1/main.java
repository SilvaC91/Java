...
public class main {
    ...
    public static void exercise1() {
        ...
        String StringResult = StrSum("Hello", "world");
        System.out.println(StringResult);


    }
        static String StrSum(String str1, String str2){
        int num = str1.length()+ str2.length();
            String sum = str1.toUpperCase() + str2.toUpperCase() + num ;
            return  sum;
        }
...
//        String password = Password(NOMI, STRINGHE, CITTA);
//        System.out.println(password);
    }
    public static String Password(List<String> nomi, List<String> casuale, List<String> citta){
        String password = //nomi.get(1)
//                + casuale.get(1)
//                + citta.get(0);
//        return password;
    }
...
//        tennisPlayer player1 = new tennisPlayer("1","Federer",3,6);
