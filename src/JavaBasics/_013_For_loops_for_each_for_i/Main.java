package JavaBasics._013_For_loops_for_each_for_i;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        for (Integer sumA : itemsA){
            sumForA += sumA;
        }
        System.out.println("Sum for A is " + sumForA);
        ...
        System.out.println("Sum for B is " + sumForB);
        ...
        System.out.println("Sum for C is " + sumForC);
    ...
    private static void exercise4() {
        int numMultiplicationTable = 8;
        for (
                int timesTableCurrentValue = numMultiplicationTable; // <---- Edit this line
                timesTableCurrentValue <= numMultiplicationTable * 10; // <---- Edit this line
                timesTableCurrentValue = timesTableCurrentValue + numMultiplicationTable // <---- Edit this line
        ) {
    ...
    private static void exercise5() {
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++){
            // Your fori loop here
            for(int i = 0; i < 10; i++){
                System.out.println(timesTableNumber * (i+1));
            }
        }
    }
}
