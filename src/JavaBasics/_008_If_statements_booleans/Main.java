package JavaBasics._008_If_statements_booleans;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        if (remainingMoney >= lunchCost) {         // check if money are more or equal than cost of lunch
    ...
    private static void exercise3() {
        ...
        if(ourDouble > 2.5){                     //check if number is greater than 2.5
            System.out.println("Greater than 2.5");
        }else{
            ourDouble++;          //increase number by one
            if(ourDouble > 2.5){      //check if number is greater than 2.5
    ...
    private static void exercise4() {
        ...
        if (employeeAge >= 65) {               //check if age is greater or equal to 65
            System.out.println("Retired");
        } else if (employeeAge >= 35 && employeeAge < 65) {  //check if age is greater or equal to 35 and less than 65
            System.out.println("Experienced Worker");
        } else if (employeeAge >= 18 && employeeAge < 35) {  //check if age is greater or equal to 18 and less than 35
