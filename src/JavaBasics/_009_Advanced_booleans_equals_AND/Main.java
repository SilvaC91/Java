package JavaBasics._009_Advanced_booleans_equals_AND;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        int minAge = 18;
        boolean ageExpected = age >= 18;
        boolean moneyNeeded = eurosInPocket >= eurosForEntry;
        boolean shoesExpected = shoeType == "fancy";

        if(ageExpected && moneyNeeded && shoesExpected){
