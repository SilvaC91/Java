package JavaBasics._015_Functions_Methods;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        String celsiusToFahrenheit = conversionCelsiusToFahrenheit();
        System.out.println(celsiusToFahrenheit);
        }
    // Put this into a function
    static String conversionCelsiusToFahrenheit() {
        double celsius = 30;
    ...
    private static void exercise2() {
        ...
        static void nameOutput (String str) {
            if (str.matches(".*\\d.*")) {
    ...
    static void printAllVariables(double lunchPrice, String lunchType, String description, int weight){
        System.out.println("The price of my lunch is " + lunchPrice + ", I eat " + lunchType +
                " and it's " + description + ", the weight is " + weight + " grams");
    }
}
